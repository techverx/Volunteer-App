...
describe TitlesController do
  ...
  let(:valid_attributes) { { "vacancies" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved title as @title" do
        ...
        post :create, {:title => { "vacancies" => "invalid value" }}, valid_session
        assigns(:title).should be_a_new(Title)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested title" do
        ...
        Title.any_instance.should_receive(:update).with({ "vacancies" => "1" })
        put :update, {:id => title.to_param, :title => { "vacancies" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the title as @title" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Title.any_instance.stub(:save).and_return(false)
        put :update, {:id => title.to_param, :title => { "vacancies" => "invalid value" }}, valid_session
        assigns(:title).should eq(title)
      end
